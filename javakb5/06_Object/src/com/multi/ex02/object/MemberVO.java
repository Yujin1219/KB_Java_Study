...
//         생성자, 필드 있는 생성자, toString, getter/setter 생성한다!
    ...
    public MemberVO(String name, String phoneMum, int age, String address) {
        Name = name;
    ...
    public boolean equals(Object o) {
        ...
        return age == memberVO.age && Objects.equals(Name, memberVO.Name) && Objects.equals(phoneMum, memberVO.phoneMum) && Objects.equals(address, memberVO.address);
    }

    @Override
    public int hashCode() {
        return Objects.hash(Name, age, phoneMum, address);
    }
    ...
    public String toString() {
        ...
        sb.append(", phoneMum='").append(phoneMum).append('\'');
