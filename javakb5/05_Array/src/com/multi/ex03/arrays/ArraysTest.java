...
public class ArraysTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.compare(array1, array1)); //true : 0
        System.out.println(Arrays.compare(array1, array2)); //false : -1

        // sort : 정렬

        //1. 난수로 배열 채우기
//        Random r = new Random();
        Random r = new Random(System.currentTimeMillis()); //현재 시간으로 seed 값 초기화
        ...
        Arrays.sort(array6);
        System.out.println(Arrays.toString(array6));
        int index = Arrays.binarySearch(array6, 9); //5가 있는지 확인하는 방법
        if(index >= 0){// 값이 있음
