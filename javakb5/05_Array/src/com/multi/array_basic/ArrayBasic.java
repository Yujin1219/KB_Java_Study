...
public class ArrayBasic {
    public static void main(String[] args) {
        ...
        int[] array = null; //null로 초기화 가능하다 = 참조형이다
        array = new int[10]; //10개의 공간을 heap으로 할당하는 문법, 내부는 0으로 초기화 시켜준다.
        ...
        int[] array3 = {1, 2, 3, 4, 5, 6, 7, 8}; //가장 간단한 리터럴 표기법
        int[] array4 = new int[]{1, 2, 3, 4, 5, 6,};
//        int[] array5 = new int[10]{1, 2, 3, 4, 5, 6,}; //크기 지정하면 에러 발생
        ...
        //배열 편하게 출력하는 법 (Arrays.toString()) -> 배열을 한줄로 출력 !!
