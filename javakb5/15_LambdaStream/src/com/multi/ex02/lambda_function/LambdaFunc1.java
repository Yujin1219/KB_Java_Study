...
public class LambdaFunc1 {
    ...
    public static void main(String[] args) {
        ...
        // Math.random() 의 경우 내부적으로 new Random으로 객체를 생성한다. 하지만 Holder를 사용하므로 객체는 한번만 생성된다.
        // new Random()이 활용도가 더 높다 !!
        List<Integer> list = new ArrayList<>();
        makeRandomList(list, supplier, 10);
        System.out.println(list);
        System.out.println("------------------------------------------------------------------------------------");

        // Consumer : 소비자 void accept(T t); // 출력값이 없다? void함수사용
        ...
        printComputeNumber(list, predicate3, consumer);
        System.out.println("------------------------------------------------------------------------------------");
