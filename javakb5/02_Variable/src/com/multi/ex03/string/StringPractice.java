...
public class StringPractice {
	...
	public static void main(String[] args) {
		...
		str = new String("abc"); // String은 절대 new로 생성하지 않는다!! -> stringpool 때문에 안됨
...
//		str = "168ABCDEF";
		...
		System.out.println("C:\\dev_source\\work_space_java_multi1030\\02_Variable\\src\\com\\multi\\ex03\\string\\StringPractice.java");
