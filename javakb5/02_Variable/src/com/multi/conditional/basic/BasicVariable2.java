package com.multi.conditional.basic;
...
public class BasicVariable2 {
    ...
    public static void main(String[] args) {
        ...
        long longValue2 = 2100000000L; //L을 추천
        //long 보다 큰 수 사용할 때
        BigInteger bigInt = new BigInteger("1214214124141332342");
        BigDecimal bigDecimal = new BigDecimal("1214214124141332342");
...
//        char charValue4 = '가나다' ; // 에러!!
        ...
        System.out.println((int) charValue2);//가의 유니코드를 알고싶을 때
